...
""".format(strategyName)
  ...
  def getTextForStrategies():
    return """
☝<b>Возможно, вы уже знаете, что дисциплина – самое важное в трейдинге! Чтобы соблюдать
ее, необходимо придерживаться стратегии. Стратегия – это свод правил и действий
при определенных ситуациях на рынке.</b>
...
<b>Наша задача – помочь вам чувствовать рынок. Мы расскажем суть стратегии,
объясним как это работает на практике и в течение месяца будем определять для вас
точки входа и выхода из трейда. Каждый рабочий день мы будем присылать: </b>
...
👨‍💻Изучение стратегии - это вложение в будущее. Перед вами открывается не
